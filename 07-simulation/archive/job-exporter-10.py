...
def get_stage_requirements(passed_epochs):
    if passed_epochs < 10:
        mem = [5.5, 6.0, 6.5, 1.5]
        cpu = [2.8, 0.7, 1.0, 0.5]
        gpu = [250, 1900, 2300, 150]
    elif passed_epochs < 50:
        mem = [5.8, 6.3, 6.8, 1.7]
        cpu = [3.0, 0.8, 1.1, 0.6]
        gpu = [270, 1950, 2350, 180]
    elif passed_epochs < 100:
        mem = [6.0, 6.5, 7.0, 1.8]
        cpu = [3.1, 0.9, 1.2, 0.6]
        gpu = [290, 2000, 2400, 200]
    elif passed_epochs < 300:
        mem = [6.3, 6.8, 7.3, 2.0]
        cpu = [3.3, 1.0, 1.3, 0.7]
        gpu = [310, 2050, 2450, 220]
    else:
        mem = [6.5, 7.0, 7.5, 2.2]
        cpu = [3.5, 1.1, 1.4, 0.8]
        gpu = [330, 2100, 2500, 250]
...
def get_training_loss(passed_epochs, progress_percentage):
    loss_matrix = {
        ...
        50: [1.80, 1.75, 1.70, 1.65, 1.70],
        100: [1.50, 1.45, 1.40, 1.35, 1.40],
        300: [1.20, 1.15, 1.10, 1.05, 1.10],
        500: [1.00, 0.95, 0.90, 0.85, 0.90],
    }
