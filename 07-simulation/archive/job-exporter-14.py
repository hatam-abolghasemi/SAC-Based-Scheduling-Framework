...
def get_stage_requirements(passed_epochs):
    if passed_epochs < 10:
        mem = [6.2, 6.8, 7.3, 1.8]
        cpu = [3.0, 0.8, 1.1, 0.6]
        gpu = [280, 2000, 2400, 180]
    elif passed_epochs < 50:
        mem = [6.5, 7.0, 7.5, 2.0]
        cpu = [3.2, 0.9, 1.2, 0.7]
        gpu = [300, 2050, 2450, 210]
    elif passed_epochs < 100:
        mem = [6.8, 7.3, 7.8, 2.2]
        cpu = [3.4, 1.0, 1.3, 0.8]
        gpu = [320, 2100, 2500, 240]
    elif passed_epochs < 300:
        mem = [7.0, 7.5, 8.0, 2.5]
        cpu = [3.6, 1.1, 1.4, 0.9]
        gpu = [340, 2150, 2550, 270]
    else:
        mem = [7.3, 7.8, 8.3, 2.7]
        cpu = [3.8, 1.2, 1.5, 1.0]
        gpu = [360, 2200, 2600, 300]
...
def get_training_accuracy(passed_epochs, progress_percentage):
    accuracy_matrix = {
        ...
        100: [77.0, 78.0, 79.0, 80.0, 80.5],
        300: [82.0, 83.0, 84.0, 85.0, 86.0],
        500: [85.0, 86.0, 87.0, 88.0, 89.0],
    }
