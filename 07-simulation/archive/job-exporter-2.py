...
def get_stage_requirements(passed_epochs):
    if passed_epochs < 10:
        mem = [4.0, 4.5, 5.0, 1.0]
        cpu = [2.0, 0.5, 0.6, 0.3]
        gpu = [180, 1600, 2000, 100]
    elif passed_epochs < 50:
        mem = [4.3, 4.7, 5.2, 1.1]
        cpu = [2.2, 0.5, 0.7, 0.4]
        gpu = [200, 1650, 2050, 120]
    elif passed_epochs < 100:
        mem = [4.5, 4.9, 5.4, 1.2]
        cpu = [2.3, 0.6, 0.8, 0.4]
        gpu = [220, 1700, 2100, 150]
    elif passed_epochs < 300:
        mem = [4.8, 5.1, 5.6, 1.4]
        cpu = [2.5, 0.6, 0.9, 0.5]
        gpu = [230, 1750, 2150, 170]
    else:
        mem = [5.0, 5.3, 5.8, 1.5]
        cpu = [2.6, 0.7, 1.0, 0.5]
        gpu = [250, 1800, 2200, 180]    
...
def get_training_loss(passed_epochs, progress_percentage):
    loss_matrix = {
        ...
        50: [1.70, 1.65, 1.60, 1.55, 1.60],
        100: [1.40, 1.35, 1.30, 1.25, 1.30],
        300: [1.10, 1.05, 1.00, 0.95, 1.00],
        500: [0.95, 0.90, 0.85, 0.80, 0.85],
    }
...
def get_training_accuracy(passed_epochs, progress_percentage):
    accuracy_matrix = {
        10: [62.0, 62.5, 63.0, 63.5, 62.5],
        50: [73.0, 74.0, 75.0, 76.0, 75.5],
        100: [78.0, 79.0, 80.0, 81.0, 81.5],
        300: [82.0, 83.0, 84.0, 85.0, 86.0],
        500: [86.0, 87.0, 88.0, 89.0, 90.0],
    }
