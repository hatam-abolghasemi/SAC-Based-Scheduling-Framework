...
def get_stage_requirements(passed_epochs):
    if passed_epochs < 10:
        mem = [6.2, 6.5, 7.0, 2.1]
        cpu = [3.1, 1.0, 1.2, 0.6]
        gpu = [270, 1750, 2200, 170]
    elif passed_epochs < 50:
        mem = [6.5, 6.8, 7.3, 2.3]
        cpu = [3.3, 1.1, 1.3, 0.7]
        gpu = [290, 1800, 2250, 190]
    elif passed_epochs < 100:
        mem = [6.7, 7.0, 7.5, 2.5]
        cpu = [3.5, 1.2, 1.4, 0.7]
        gpu = [310, 1850, 2300, 210]
    elif passed_epochs < 300:
        mem = [7.0, 7.3, 7.8, 2.7]
        cpu = [3.7, 1.3, 1.5, 0.8]
        gpu = [330, 1900, 2350, 230]
    else:
        mem = [7.2, 7.5, 8.0, 2.9]
        cpu = [3.9, 1.4, 1.6, 0.9]
        gpu = [350, 1950, 2400, 250]
...
def get_training_loss(passed_epochs, progress_percentage):
    loss_matrix = {
        ...
        50: [2.60, 2.55, 2.50, 2.45, 2.50],
        100: [2.30, 2.25, 2.20, 2.15, 2.20],
        300: [2.00, 1.95, 1.90, 1.85, 1.90],
        500: [1.80, 1.75, 1.70, 1.65, 1.70],
    }
...
def get_training_accuracy(passed_epochs, progress_percentage):
    accuracy_matrix = {
        10: [54.0, 54.5, 55.0, 55.5, 55.0],
        50: [64.0, 65.0, 66.0, 67.0, 66.5],
        100: [72.0, 73.0, 74.0, 75.0, 75.5],
        300: [78.0, 79.0, 80.0, 81.0, 81.5],
        500: [82.0, 83.0, 84.0, 85.0, 85.5],
    }
