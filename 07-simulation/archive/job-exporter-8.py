...
def get_stage_requirements(passed_epochs):
    if passed_epochs < 10:
        mem = [6.5, 7.2, 7.8, 1.8]
        cpu = [3.3, 0.9, 1.3, 0.6]
        gpu = [320, 2300, 2700, 200]
    elif passed_epochs < 50:
        mem = [6.8, 7.5, 8.0, 2.0]
        cpu = [3.5, 1.0, 1.4, 0.7]
        gpu = [340, 2350, 2750, 220]
    elif passed_epochs < 100:
        mem = [7.0, 7.8, 8.3, 2.2]
        cpu = [3.6, 1.1, 1.5, 0.8]
        gpu = [360, 2400, 2800, 250]
    elif passed_epochs < 300:
        mem = [7.3, 8.0, 8.5, 2.5]
        cpu = [3.8, 1.2, 1.6, 0.9]
        gpu = [380, 2450, 2850, 280]
    else:
        mem = [7.5, 8.3, 8.8, 2.7]
        cpu = [4.0, 1.3, 1.7, 1.0]
        gpu = [400, 2500, 2900, 300]
...
def get_training_loss(passed_epochs, progress_percentage):
    loss_matrix = {
        10: [2.30, 2.30, 2.30, 2.30, 2.30],
        50: [1.90, 1.85, 1.80, 1.75, 1.80],
        100: [1.60, 1.55, 1.50, 1.45, 1.50],
        300: [1.30, 1.25, 1.20, 1.15, 1.20],
        500: [1.10, 1.05, 1.00, 0.95, 1.00],
    }
...
def get_training_accuracy(passed_epochs, progress_percentage):
    accuracy_matrix = {
        10: [62.0, 62.5, 63.0, 63.5, 63.0],
        50: [74.0, 75.0, 76.0, 77.0, 76.5],
        100: [80.0, 81.0, 82.0, 83.0, 83.5],
        300: [85.0, 86.0, 87.0, 88.0, 89.0],
        500: [88.0, 89.0, 90.0, 91.0, 92.0],
    }
