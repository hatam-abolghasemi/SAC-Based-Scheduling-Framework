...
def get_stage_requirements(passed_epochs):
    if passed_epochs < 10:
        mem = [8.5, 9.0, 9.8, 2.5]
        cpu = [4.2, 1.3, 1.7, 0.9]
        gpu = [450, 2800, 3200, 300]
    elif passed_epochs < 50:
        mem = [8.8, 9.3, 10.0, 2.8]
        cpu = [4.4, 1.4, 1.8, 1.0]
        gpu = [470, 2850, 3250, 330]
    elif passed_epochs < 100:
        mem = [9.0, 9.5, 10.3, 3.0]
        cpu = [4.6, 1.5, 1.9, 1.1]
        gpu = [490, 2900, 3300, 360]
    elif passed_epochs < 300:
        mem = [9.3, 9.8, 10.5, 3.3]
        cpu = [4.8, 1.6, 2.0, 1.2]
        gpu = [510, 2950, 3350, 390]
    else:
        mem = [9.5, 10.0, 10.8, 3.5]
        cpu = [5.0, 1.7, 2.1, 1.3]
        gpu = [530, 3000, 3400, 420]
...
def get_training_accuracy(passed_epochs, progress_percentage):
    accuracy_matrix = {
        ...
        300: [81.0, 82.0, 83.0, 84.0, 85.0],
        500: [84.0, 85.0, 86.0, 87.0, 88.0],
    }
