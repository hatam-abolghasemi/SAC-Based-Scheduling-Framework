...
def get_stage_requirements(passed_epochs):
    if passed_epochs < 10:
        mem = [9.0, 9.5, 10.0, 2.5]
        cpu = [4.5, 1.4, 1.8, 0.9]
        gpu = [500, 3000, 3500, 320]
    elif passed_epochs < 50:
        mem = [9.3, 9.8, 10.3, 2.8]
        cpu = [4.7, 1.5, 1.9, 1.0]
        gpu = [520, 3050, 3550, 350]
    elif passed_epochs < 100:
        mem = [9.5, 10.0, 10.5, 3.0]
        cpu = [4.9, 1.6, 2.0, 1.1]
        gpu = [540, 3100, 3600, 380]
    elif passed_epochs < 300:
        mem = [9.8, 10.3, 10.8, 3.3]
        cpu = [5.1, 1.7, 2.1, 1.2]
        gpu = [560, 3150, 3650, 410]
    else:
        mem = [10.0, 10.5, 11.0, 3.5]
        cpu = [5.3, 1.8, 2.2, 1.3]
        gpu = [580, 3200, 3700, 440]
...
def get_training_loss(passed_epochs, progress_percentage):
    loss_matrix = {
        ...
        100: [1.80, 1.75, 1.70, 1.65, 1.70],
        300: [1.50, 1.45, 1.40, 1.35, 1.40],
...
def get_training_accuracy(passed_epochs, progress_percentage):
    accuracy_matrix = {
        ...
        100: [74.0, 75.0, 76.0, 77.0, 77.5],
        300: [80.0, 81.0, 82.0, 83.0, 84.0],
        500: [83.0, 84.0, 85.0, 86.0, 87.0],
    }
