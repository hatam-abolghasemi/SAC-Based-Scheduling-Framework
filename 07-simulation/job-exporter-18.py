...
def get_stage_requirements(passed_epochs):
    if passed_epochs < 10:
        mem = [5.5, 6.0, 6.5, 1.8]
        cpu = [2.8, 0.8, 1.0, 0.5]
        gpu = [220, 1750, 2200, 140]
    elif passed_epochs < 50:
        mem = [5.8, 6.3, 6.8, 2.0]
        cpu = [3.0, 0.9, 1.1, 0.6]
        gpu = [240, 1800, 2250, 160]
    elif passed_epochs < 100:
        mem = [6.0, 6.5, 7.0, 2.2]
        cpu = [3.2, 1.0, 1.2, 0.6]
        gpu = [260, 1850, 2300, 180]
    elif passed_epochs < 300:
        mem = [6.3, 6.8, 7.3, 2.5]
        cpu = [3.4, 1.1, 1.3, 0.7]
        gpu = [280, 1900, 2350, 200]
    else:
        mem = [6.5, 7.0, 7.5, 2.7]
        cpu = [3.6, 1.2, 1.4, 0.8]
        gpu = [300, 1950, 2400, 220]
...
def get_training_loss(passed_epochs, progress_percentage):
    loss_matrix = {
        10: [2.60, 2.60, 2.60, 2.60, 2.60],
        50: [2.30, 2.25, 2.20, 2.15, 2.20],
        100: [2.00, 1.95, 1.90, 1.85, 1.90],
        300: [1.70, 1.65, 1.60, 1.55, 1.60],
        500: [1.40, 1.35, 1.30, 1.25, 1.30],
    }
...
def get_training_accuracy(passed_epochs, progress_percentage):
    accuracy_matrix = {
        10: [52.0, 52.5, 53.0, 53.5, 53.0],
        50: [62.0, 63.0, 64.0, 65.0, 64.5],
        100: [70.0, 71.0, 72.0, 73.0, 73.5],
        300: [75.0, 76.0, 77.0, 78.0, 79.0],
        500: [78.0, 79.0, 80.0, 81.0, 82.0],
    }
