...
def get_stage_requirements(passed_epochs):
    if passed_epochs < 10:
        mem = [9.2, 9.6, 10.2, 2.6]
        cpu = [4.6, 1.5, 1.9, 1.0]
        gpu = [520, 3050, 3550, 340]
    elif passed_epochs < 50:
        mem = [9.5, 9.9, 10.5, 2.9]
        cpu = [4.8, 1.6, 2.0, 1.1]
        gpu = [540, 3100, 3600, 370]
    elif passed_epochs < 100:
        mem = [9.7, 10.1, 10.7, 3.1]
        cpu = [5.0, 1.7, 2.1, 1.2]
        gpu = [560, 3150, 3650, 400]
    elif passed_epochs < 300:
        mem = [10.0, 10.4, 11.0, 3.4]
        cpu = [5.2, 1.8, 2.2, 1.3]
        gpu = [580, 3200, 3700, 430]
    else:
        mem = [10.2, 10.6, 11.2, 3.6]
        cpu = [5.4, 1.9, 2.3, 1.4]
        gpu = [600, 3250, 3750, 460]
...
def get_training_accuracy(passed_epochs, progress_percentage):
    accuracy_matrix = {
        10: [60.0, 60.5, 61.0, 61.5, 61.0],
        50: [70.0, 71.0, 72.0, 73.0, 72.5],
        100: [78.0, 79.0, 80.0, 81.0, 81.5],
        300: [84.0, 85.0, 86.0, 87.0, 87.5],
