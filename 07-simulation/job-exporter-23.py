...
def get_stage_requirements(passed_epochs):
    if passed_epochs < 10:
        mem = [4.3, 4.6, 5.0, 1.3]
        cpu = [2.2, 0.6, 0.8, 0.4]
        gpu = [180, 1200, 1500, 110]
    elif passed_epochs < 50:
        mem = [4.5, 4.8, 5.2, 1.5]
        cpu = [2.4, 0.7, 0.9, 0.5]
        gpu = [190, 1250, 1550, 130]
    elif passed_epochs < 100:
        mem = [4.7, 5.0, 5.4, 1.7]
        cpu = [2.6, 0.8, 1.0, 0.5]
        gpu = [200, 1300, 1600, 150]
    elif passed_epochs < 300:
        mem = [5.0, 5.3, 5.7, 1.9]
        cpu = [2.8, 0.9, 1.1, 0.6]
        gpu = [210, 1350, 1650, 170]
    else:
        mem = [5.2, 5.5, 6.0, 2.1]
        cpu = [3.0, 1.0, 1.2, 0.7]
        gpu = [220, 1400, 1700, 190]
...
def get_training_loss(passed_epochs, progress_percentage):
    loss_matrix = {
        ...
        100: [2.20, 2.15, 2.10, 2.05, 2.10],
        300: [2.00, 1.95, 1.90, 1.85, 1.90],
        500: [1.70, 1.65, 1.60, 1.55, 1.60],
    }
...
def get_training_accuracy(passed_epochs, progress_percentage):
    accuracy_matrix = {
        ...
        100: [69.0, 70.0, 71.0, 72.0, 72.5],
        300: [75.0, 76.0, 77.0, 78.0, 78.5],
