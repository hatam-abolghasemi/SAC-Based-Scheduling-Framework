...
def get_stage_requirements(passed_epochs):
    if passed_epochs < 10:
        mem = [9.8, 10.2, 10.8, 2.8]
        cpu = [4.9, 1.7, 2.0, 1.1]
        gpu = [560, 3200, 3700, 360]
    elif passed_epochs < 50:
        mem = [10.0, 10.4, 11.0, 3.0]
        cpu = [5.1, 1.8, 2.1, 1.2]
        gpu = [580, 3250, 3750, 390]
    elif passed_epochs < 100:
        mem = [10.2, 10.6, 11.2, 3.2]
        cpu = [5.3, 1.9, 2.2, 1.3]
        gpu = [600, 3300, 3800, 420]
    elif passed_epochs < 300:
        mem = [10.5, 10.9, 11.5, 3.5]
        cpu = [5.5, 2.0, 2.3, 1.4]
        gpu = [620, 3350, 3850, 450]
    else:
        mem = [10.7, 11.1, 11.7, 3.7]
        cpu = [5.7, 2.1, 2.4, 1.5]
        gpu = [640, 3400, 3900, 480]
...
def get_training_loss(passed_epochs, progress_percentage):
    loss_matrix = {
        10: [2.90, 2.90, 2.90, 2.90, 2.90],
        50: [2.50, 2.45, 2.40, 2.35, 2.40],
...
def get_training_accuracy(passed_epochs, progress_percentage):
    accuracy_matrix = {
        10: [58.0, 58.5, 59.0, 59.5, 59.0],
        50: [68.0, 69.0, 70.0, 71.0, 70.5],
        100: [76.0, 77.0, 78.0, 79.0, 79.5],
        300: [82.0, 83.0, 84.0, 85.0, 85.5],
