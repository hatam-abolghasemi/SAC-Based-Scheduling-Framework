...
job_generator_url = 'http://0.0.0.0:9802/jobs'
job_deploy_url = 'http://0.0.0.0:9801/deploy_job'
queue_url = 'http://0.0.0.0:9802/queue'
...
class deepLearningEnvironment(gym.Env):
    ...
    def fetch_state(self):
        response = requests.get("http://0.0.0.0:9807/state")
